...
public class SinglePost extends ActionBarActivity {
    ...
    void updateDiscussions(Object output) throws JSONException {
        ...
        for (int i = 0; i < tags.length(); i++) {
            TagView text = new TagView(this.getApplicationContext());
            ...
            text.setOnClickListener(new OnTagClickListener(tags.getString(i)) {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(SinglePost.this, TagDetail.class);
