...
public class Controller {
    ...
    public static void sendRegistrationID(List<NameValuePair> data, Callback callback) {
        String endpoint = "/users/regid";
    ...
    public static void getTagDetails(Callback callback, String tag) {
        String endpoint = "tags/" + tag;
        URLContext context = new URLContext(url + endpoint, "GET", callback);
        new AsyncHTTP(callback).execute(context);
    }
